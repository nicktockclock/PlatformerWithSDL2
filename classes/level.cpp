...
void Level::loadMap(std::string mapName, Graphics &graphics){
        ...
        while (pLayer){
            ...
            if (pData != NULL){
                while (pData){
                    ...
                    if (pTile != NULL){
                        //Keep track of what tile we're on
                        int tileCounter = 0;
                        while (pTile){
                            //Build each individual tile here
                            //If the gid is 0 draw nothing
                            ...
                            for (int i = 0; i < _tilesets.size(); i++){
                                //Gids for each tileset are sequential, i.e 
                                //For tileset 1 gids are 1-20, with firstgid being 1
                                //For tileset 2 gids are 21-40, with firstgid being 21
                            ...
                            //Build the actual tile and add it to the levels tilelist
    ...
    //Parse out the collisions in the level
